...
Partial Public Class Database2DataSet1
    ...
    Partial Public Class Table1DataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddTable1Row(ByVal Name As String, ByVal Price As String, ByVal MFG_Date As String, ByVal EXP_Date As String, ByVal ID As String) As Table1Row
            Dim rowTable1Row As Table1Row = CType(Me.NewRow,Table1Row)
            Dim columnValuesArray() As Object = New Object() {Name, Price, MFG_Date, EXP_Date, ID}
...
Namespace Database2DataSet1TableAdapters
    ...
    Partial Public Class Table1TableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Table1` (`Name`, `Price`, `MFG_Date`, `EXP_Date`, `ID`) VALUES (?, ?"& _ 
                ", ?, ?, ?)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Name, Price, MFG_Date, EXP_Date, ID FROM Table1"
        ...
        Public Overloads Overridable Function Insert(ByVal Name As String, ByVal Price As String, ByVal MFG_Date As String, ByVal EXP_Date As String, ByVal ID As String) As Integer
